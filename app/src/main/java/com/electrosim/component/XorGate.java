 ...
 *
 */
public class XorGate extends SimElement {

	int portcountinput;
	Integer defValue;

Resources res;	
	public XorGate(float x, float y,Container container, int portcountinput, Resources resources) {
		super(container);
		res=resources;
	...
	if(portcountinput==2)
	{
		...
		initiailizeElement(BitmapFactory.decodeResource(resources, R.drawable.ugate1), x, y);
	...
	{
		initiailizeElement(BitmapFactory.decodeResource(resources, R.drawable.ufourgate1), x, y);
...
protected void prepareToStart() {
	...
	public ElementInterface createNew() {
		return new XorGate(x,y,container,portcountinput,res);
	}
