 ...
 *
 */
public class NandGate extends SimElement {

	int portcountinput;
	Integer defValue;

Resources res;	
	public NandGate(float x, float y,Container container, int portcountinput, Resources resources) {
		super(container);
		res=resources;
	...
	if(portcountinput==2)
	{
		...
		initiailizeElement(BitmapFactory.decodeResource(resources, R.drawable.ugate6), x, y);
	...
	{
		initiailizeElement(BitmapFactory.decodeResource(resources, R.drawable.ufourgate6), x, y);
...
protected void prepareToStart() {
	...
	public ElementInterface createNew() {
		return new NandGate(x,y,container,portcountinput,res);
	}
