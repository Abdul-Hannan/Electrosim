 ...
 *
 */
public class NorGate extends SimElement {

	int portcountinput;
	Integer defValue;

Resources res;	
	public NorGate(float x, float y,Container container, int portcountinput, Resources resources) {
		super(container);
		res=resources;
	...
	if(portcountinput==2)
	{
		...
		initiailizeElement(BitmapFactory.decodeResource(resources, R.drawable.ugate4), x, y);
	...
	{
		initiailizeElement(BitmapFactory.decodeResource(resources, R.drawable.ufourgate4), x, y);
...
protected void prepareToStart() {
	...
	public ElementInterface createNew() {
		return new NorGate(x,y,container,portcountinput,res);
	}
